...
### *2.1.1. ¿Cómo declarar una variable en Python?*

#### *2.1.1.1. Declaración de variables:*

Para declarar una variable en Python, *basta con asignarle un **" nombre "** a la variable, seguido del signo **" = "** y finalmente el **valor, texto, oración, etc...***; que uno desea *" almacenar "* en dicha variable.

Teniendo un resultado como: **" variable_n = 1234 ", " variable_t = "número" ", "variable_o = "palabra otra palabra más palabras etc..."**, etc... 

>> En los siguientes apartados explico más a detalle como declarar cada tipo de variables

---

> IMPORTANTE: Una vez " declarada una o más variables " en Python, éstas serán guardadas en el mismo archivo HASTA QUE SE CIERRE.

> Por lo que, si uno necesita trabajar otra vez con estas variables al abrir el archivo, se necesita ejecutar otra vez las " líneas de código donde se declararon dichas variables ", lo que permitirá trabajar nuevamente con ellas.
...
> Cabe aclarar que en este cuadernillo todavía no entraré en el aspecto de las funciones para visualizar o realizar operaciones entre las variables; por lo que, me enfocaré solamente en como declararlas correctamente y evitar errores en Python
...
#### *2.1.1.4. ¿Se pueden declarar varias variables con el mismo nombre?*

En terminos simples, NO ESTÁ PERMITIDO de ninguna manera declarar variables con un mismo nombre; ya que, en cualquier "entorno de programación" utilizado para: desarrollo web, back end, front end, etc... (incluyendo el análisis de datos); esta práctica resulta contraproducente y puede provocar bastante errores al momento de ejecutar el código

>> Por eso mismo, hago mucho hincapié en la estandarización del uso de signos, mayúsculas y otro elementos al momento de generar una base de datos y/o declarar variables
...
Siguiendo la explicación de los datos tipo **"int"**; para declarar una variable de este tipo, basta con asignarle un **"número entero sin decimales"**:
...
Siguiendo la explicación de los datos tipo **"float"**; para declarar una variable de este tipo, basta con asignarle un **"número con "n" cantidad de decimales"**:
...
Siguiendo la explicación de los datos tipo **"string"**; para declarar una variable de este tipo, basta con asignarle **" una palabra o texto entre comillas "_" "**:
...
Siguiendo la explicación de los datos de tipo **"bool"**; para declarar una variable de este tipo, basta con asignarle **"una comparación entre datos de cualquier tipo"** (incluyendo listas y diccionarios)
...
Siguiendo la explicación de los datos de tipo "list"; para declarar una variable de este tipo, basta con asignarle "un conjunto datos de cualquier tipo entre corchetes []":
...
Siguiendo la explicación de los datos de tipo **"dict"**; para declarar una variable de este tipo, basta con asignarle **"un conjunto de datos de cualquier tipo entre llaves {}"**, recordando que a cada **"entrada"** hay que asignarle su respectiva **"información gramatical"**
...
1. Así como en el antarior apartado, quise hacer demasiado hincapié en la estandarización y organización de los diferentes elementos que se vayan a utilizar al momento de realizar un análisis de datos o en general en la programación en el "entorno" de Python; ya que, es muy fácil cometer errores o perderse al momento de declarar demasiadas variables que, por la misma situación de olvidarse de escribir correctamente la misma, puede generar mucha confusión y desesperación el no entender porque arroja el mismo error una y otra vez
